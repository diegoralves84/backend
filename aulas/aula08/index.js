...
async function main () {
    while(true) {
        ...
        switch(parseInt(opcao)){
            ...
            case 3: {
                const nomeBusca = readline.question("Nome da tarefa a ser alterada: ");
                const nome = readline.question("Digite o OUTRO nome da tarefa: ");
                const concluida = readline.question("Informe outra situação para tarefa: ");
                await alterar (nomeBusca, nome, concluida);
                break;
            }
            case 4: {
                const nome = readline.question("Nome da tarefa a ser excluida: ");
                await remover(nome);
                break;
            }
